...
/**
 * @file
 * Contains \Drupal\entityform\Entity\EntityformRouteProvider
 */
...
/**
 * Provides routes for Entityforms
 */
class EntityformRouteProvider implements EntityRouteProviderInterface {
